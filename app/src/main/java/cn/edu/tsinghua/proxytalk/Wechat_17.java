...
public class Wechat_17 extends ActionDrivenLayout {
    private static String GREETING = "在位置";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_17(MyExampleClass context, String lowLevelPageName) {
    ...
    public void onLoad() {
        ...
        registerAction(new ITaskCallback<Result>() {
            ...
            public void run(Result result) {
                Map<String, String> paraValues = new ArrayMap<>();
                switchPages("com.tencent.mm-18", paraValues);
            }
        }, "共享实时位置");
