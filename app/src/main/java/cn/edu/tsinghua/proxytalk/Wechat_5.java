...
public class Wechat_5 extends ActionDrivenLayout {
    private static String GREETING = "在个人信息";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_5(MyExampleClass context, String lowLevelPageName) {
