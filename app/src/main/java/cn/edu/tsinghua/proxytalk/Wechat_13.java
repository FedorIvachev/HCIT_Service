...
public class Wechat_13 extends ActionDrivenLayout {
    private static String GREETING = "在音视频通话";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_13(MyExampleClass context, String lowLevelPageName) {
