...
public class Alipay_151 extends ActionDrivenLayout {
    private static String GREETING = "在转到银行卡";
    public static final String TAG  = "VOICE_Assistant";

    public Alipay_151(MyExampleClass context, String lowLevelPageName) {
