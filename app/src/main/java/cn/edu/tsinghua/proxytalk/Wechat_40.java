...
public class Wechat_40 extends ActionDrivenLayout {
    private static String GREETING = "在应急联系人";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_40(MyExampleClass context, String lowLevelPageName) {
