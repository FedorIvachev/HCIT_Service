...
public class Wechat_27 extends ActionDrivenLayout {
    private static String GREETING = "在群聊名";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_27(MyExampleClass context, String lowLevelPageName) {
