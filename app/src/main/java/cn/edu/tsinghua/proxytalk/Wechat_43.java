...
public class Wechat_43 extends ActionDrivenLayout {
    private static String GREETING = "在通用";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_43(MyExampleClass context, String lowLevelPageName) {
    ...
    public void onLoad() {
        ...
        registerAction(new ITaskCallback<Result>() {
            ...
            public void run(Result result) {
                ...
                switchPages("com.tencent.mm-38", paraValues);
            }
        }, "返回");
        ...
        registerAction(new ITaskCallback<Result>() {
            ...
            public void run(Result result) {
                Map<String, String> paraValues = new ArrayMap<>();
                switchPages("com.tencent.mm-44", paraValues);
            }
        }, "字体大小");
