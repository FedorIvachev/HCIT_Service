...
public class Wechat_35 extends ActionDrivenLayout {
    private static String GREETING = "在群二维码";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_35(MyExampleClass context, String lowLevelPageName) {
