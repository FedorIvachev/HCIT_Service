...
public class Wechat_18 extends ActionDrivenLayout {
    private static String GREETING = "在实时位置";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_18(MyExampleClass context, String lowLevelPageName) {
