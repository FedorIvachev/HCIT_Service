...
public class Wechat_22 extends ActionDrivenLayout {
    private static String GREETING = "在翻译";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_22(MyExampleClass context, String lowLevelPageName) {
