...
public class Wechat_38 extends ActionDrivenLayout {
    private static String GREETING = "在设置";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_38(MyExampleClass context, String lowLevelPageName) {
