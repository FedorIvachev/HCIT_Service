...
public class Wechat_19 extends ActionDrivenLayout {
    private static String GREETING = "在相册";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_19(MyExampleClass context, String lowLevelPageName) {
