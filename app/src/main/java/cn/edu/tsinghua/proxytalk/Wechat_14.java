...
public class Wechat_14 extends ActionDrivenLayout {
    private static String GREETING = "在语音通话";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_14(MyExampleClass context, String lowLevelPageName) {
