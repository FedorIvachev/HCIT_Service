...
public class Wechat_37 extends ActionDrivenLayout {
    private static String GREETING = "标签";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_37(MyExampleClass context, String lowLevelPageName) {
