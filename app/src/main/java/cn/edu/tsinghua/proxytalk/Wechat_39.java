...
public class Wechat_39 extends ActionDrivenLayout {
    private static String GREETING = "在账号与安全";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_39(MyExampleClass context, String lowLevelPageName) {
