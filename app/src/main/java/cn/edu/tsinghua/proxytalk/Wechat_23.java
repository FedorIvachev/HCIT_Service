...
public class Wechat_23 extends ActionDrivenLayout {
    private static String GREETING = "在支付";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_23(MyExampleClass context, String lowLevelPageName) {
