...
public class Alipay_61 extends ActionDrivenLayout {
    private static String GREETING = "在付钱";
    public static final String TAG  = "VOICE_Assistant";

    public Alipay_61(MyExampleClass context, String lowLevelPageName) {
