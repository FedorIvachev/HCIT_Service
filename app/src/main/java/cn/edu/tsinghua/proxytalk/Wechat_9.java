...
public class Wechat_9 extends ActionDrivenLayout {
    private static String GREETING = "在微信号/QQ号/手机号";
    public static final String TAG  = "VOICE_Assistant";

    public Wechat_9(MyExampleClass context, String lowLevelPageName) {
